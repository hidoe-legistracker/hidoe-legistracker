export const COMPONENT_IDS = {
  ...
  NAVBAR_HEARINGS_PAGE: 'navbar-hearings-page',
  ...
  CREATE_MEASURE_FORM_MEASURE_TYPE: 'create-measure-form-measure-type',
  ...
  INBOX_EMAIL_SELECT_ALL: 'inbox-email-select-all',
};
